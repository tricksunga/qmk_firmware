...
[_LAYER2] = LAYOUT_preonic_grid(
    ...
    KC_NO, REPEAT_MACRO, REPEAT_MACRO2, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_PSCR, KC_SCRL, KC_PAUS, KC_F12, 
...
void matrix_scan_user(void) {
    // Handle REPEAT_MACRO (3 + space with random delays)
    ...
    // Handle REPEAT_MACRO2 (2 + space + space with fixed delays)
